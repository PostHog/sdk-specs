...
- If sync is requested, use the Skill tool to invoke `openspec-sync-specs` synchronously, verify every delta was applied, and stop without archiving on any failure
