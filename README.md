...
| Metrics | [`openspec/specs/metrics/spec.md`](openspec/specs/metrics/spec.md) | product | Canonical |
...
| Exception Event Metadata | [`openspec/specs/exception-event-metadata/spec.md`](openspec/specs/exception-event-metadata/spec.md) | internal behavior (client/server) | Canonical |
...
| Session Replay Debug Properties | [`openspec/specs/session-replay-debug-properties/spec.md`](openspec/specs/session-replay-debug-properties/spec.md) | internal behavior | Canonical |
