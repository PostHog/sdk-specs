...
- **BREAKING** for SDKs that currently expose malformed payloads as raw strings.
...
Changing evaluation, network fallback, tracking, or valid-payload return types; fixing the Python PR or resolving its review threads.
