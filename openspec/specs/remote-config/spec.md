...
`both` — applies to client and server SDKs that implement project remote configuration. It does not require SDKs without this capability to add it. Each SDK applies only the configuration for features it supports.
