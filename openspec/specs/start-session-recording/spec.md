...
- Invalid replay configuration or a replay integration that fails to initialize is contained the same way: the call no-ops or logs and does not throw into host application code.
